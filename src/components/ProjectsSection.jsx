...
const projects = [
  ...
  {
    id: 6,
    title: "Trustpad - DeFi Launchpad",
    description: "Trustpad built with Next,Node,Web3,TailwindCSS and EtherJS - A decentralized launchpad for token sales.",
  ...
  {
    id: 7,
    title: "Tangible - NFT Marketplace",
    description: "Tangible NFT marketplace built with Next,Node,EtherJS and TailwindCSS.",
  ...
  {
    id: 10,
    title: "Prestige - Luxury Car Marketplace",
    description: "Prestige luxury car marketplace built using Nuxt,Node,MongoDB.",
